...
// mutex. External callers must use the Read/Write callback APIs so that pointers
// never escape the locks.
...
public:
    ...
    void Read(uint64_t object_id, ComponentType type, ReadCallback callback) const;
