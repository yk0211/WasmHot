 ...
 * ------------------------------------------------------------ */
__attribute__((import_module("host"), import_name("get_current_object_id")))
extern int64_t host_get_current_object_id(void);

__attribute__((import_module("host"), import_name("get_component")))
extern int32_t host_get_component(int64_t object_id,
                                   int32_t type,
                                   int32_t buf_ptr,
                                   int32_t buf_cap);

__attribute__((import_module("host"), import_name("set_component")))
extern int32_t host_set_component(int64_t object_id,
                                   int32_t type,
                                   int32_t buf_ptr,
                                   int32_t len);
...
int32_t execute(int64_t action_hash,
